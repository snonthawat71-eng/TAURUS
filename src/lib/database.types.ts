...
export interface TransitLeg {
  ...
  /** estimated cost of this leg */
  fare?: number
  /** currency the fare is in — a multi-city trip pays each leg in the money of
   *  the city it's in, so this is per leg. Absent = the trip's own currency. */

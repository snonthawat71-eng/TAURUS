...
export const TRANSIT_MODES: TransitModeMeta[] = [
  ...
  { key: 'bus', label: 'รถเมล์', short: 'รถเมล์', icon: IconBus, color: '#0270FB', rail: false,
    fields: { line: 'สายรถเมล์', from: 'ป้ายขึ้น', to: 'ป้ายลง', linePlaceholder: 'เช่น สาย 8 / 511' } },
  { key: 'tram', label: 'รถราง', short: 'รถราง', icon: IconBus, color: '#0270FB', rail: false,
    fields: { line: 'สายรถราง', from: 'สถานีขึ้น', to: 'สถานีลง', linePlaceholder: 'เช่น Tram 2' } },
  { key: 'hsr', label: 'รถไฟความเร็วสูง', short: 'รถไฟด่วน', icon: IconTrainFilled, color: '#0270FB', rail: false,
    fields: { line: 'ขบวน/สาย', from: 'สถานีต้นทาง', to: 'สถานีปลายทาง', linePlaceholder: 'เช่น G1234 / Shinkansen' } },
  { key: 'car', label: 'รถยนต์ส่วนตัว', short: 'รถยนต์', icon: IconCar, color: '#0270FB', rail: false,
    fields: { line: 'เส้นทาง', from: 'ต้นทาง', to: 'ปลายทาง', linePlaceholder: 'เช่น ทางด่วน / เส้นเลียบทะเล' } },
  { key: 'taxi', label: 'แท็กซี่', short: 'แท็กซี่', icon: IconCarFilled, color: '#0270FB', rail: false,
    fields: { line: 'บริการ', from: 'จุดรับ', to: 'จุดส่ง', linePlaceholder: 'เช่น Grab / แท็กซี่มิเตอร์' } },
  { key: 'boat', label: 'เรือ', short: 'เรือ', icon: IconSailboat, color: '#0270FB', rail: false,

...
// Osaka Metro — main lines. Interchange stations share an id across lines.
// Topology (order + interchanges) is the important part for routing; coordinates
// are schematic and easy to tweak.

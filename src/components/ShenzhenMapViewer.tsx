  ...
  return createPortal(
    <div className="fixed inset-0 z-[120] bg-canvas flex flex-col">
      ...
      <div className="shrink-0 p-4 bg-surface" style={{ borderTop: '0.5px solid var(--color-line)', maxHeight: '40dvh', overflowY: 'auto' }}>
        ...
        <p className="text-[11px] text-ink-3 mt-2.5">แผนผังแสดงเส้นทาง สี และชื่อสถานี — ใช้ดูประกอบขณะกรอกเส้นทางการเดินทางด้านล่าง (ชื่อสาย/สถานีมีให้เลือกอัตโนมัติในช่องกรอก)</p>
      </div>
    </div>,
    document.body,
  )
